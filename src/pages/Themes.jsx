import { PageShell, Section, DemoCard, CodeBlock } from './showcase/Parts';
...
const applyCode = `// Light "Zinc" base with an orange accent
document.documentElement.className = 'theme-zinc accent-orange';

// Flip to dark mode
document.documentElement.setAttribute('data-theme', 'dark');`;

const previewCode = `<div className="block-card" style={{ maxWidth: 420 }}>
  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
    <strong>Upgrade your plan</strong>
    <span className="ui-badge solid">Pro</span>
  </div>
  <p>Unlock advanced analytics and priority support.</p>
...
const Themes = () => (
  ...
  >
    ...
    <Section title="How to apply" description="Themes are toggled with classes and a data attribute on the root element.">
      <CodeBlock language="js" code={applyCode} />
    ...
    <Section title="Live preview" description="A sample card rendered with the currently active theme.">
      <DemoCard label="Themed card" code={previewCode}>
        <div className="block-card" style={{ maxWidth: 420, width: '100%' }}>
