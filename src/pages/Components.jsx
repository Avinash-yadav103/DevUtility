...
const Components = () => {
  ...
  return (
    <PageShell
      eyebrow="UI Kit"
      title="Components"
      lead="The building blocks of the design system — accessible, themeable primitives that respond to the active base palette and accent color. Toggle the Code tab on any example to copy its source."
    >
      <Section title="Buttons" description="Five variants and three sizes, all driven by the accent token.">
        <Grid>
          <DemoCard
            label="Variants"
            code={`<button className="ui-btn ui-btn-primary">Primary</button>
...
<button className="ui-btn ui-btn-destructive">Delete</button>`}
          ...
          <DemoCard
            label="Sizes & states"
            code={`<button className="ui-btn ui-btn-primary ui-btn-sm">Small</button>
...
<button className="ui-btn ui-btn-primary" disabled>Disabled</button>`}
          ...
          <DemoCard
            label="With icon"
            code={`<button className="ui-btn ui-btn-primary">
  <CheckIcon /> Confirm
</button>
  ...
  <PlusIcon /> Add new
      ...
      <Section title="Badges" description="Compact status labels and counts.">
        <Grid>
          <DemoCard
            label="Styles"
            code={`<span className="ui-badge solid">Solid</span>
...
/>`}
          ...
          <DemoCard
            ...
            stageClassName="col"
            code={`<span className="ui-check" data-on={checked}>
  {checked && <CheckIcon />}
</span>

<span className="ui-radio" data-on={selected === 'a'} />
<span className="ui-radio" data-on={selected === 'b'} />`}
          >
      ...
      <Section title="Feedback" description="Alerts and progress indicators.">
        <Grid cols={2}>
          <DemoCard
            label="Alerts"
            stageClassName="col"
            code={`<div className="ui-alert info">
  <span className="ui-alert-icon">ℹ️</span>
  <div>
    <span className="ui-alert-title">Heads up</span>
    A new version is available.
  </div>
</div>

<div className="ui-alert success">…</div>
<div className="ui-alert danger">…</div>`}
          >
          ...
          <DemoCard
            label="Progress"
            stageClassName="col"
            code={`<div className="ui-progress">
  <span style={{ width: '35%' }} />
</div>
...
<div className="ui-tablist">
    ...
    >
      {t}
          ...
          <DemoCard
            label="Avatars & kbd"
            stageClassName="col"
            code={`<div className="ui-avatar-stack">
  ...
  <span className="ui-avatar">+5</span>
</div>
